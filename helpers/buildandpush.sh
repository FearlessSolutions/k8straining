...
docker tag k8straining_nest2 us.gcr.io/fearless-sandbox-2019/k8straining_frontend:latest
...
docker push us.gcr.io/fearless-sandbox-2019/k8straining_frontend:latest